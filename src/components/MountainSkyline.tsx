...
const STARS = [
  { x: 4, y: 12, s: 3, d: 0 }, { x: 9, y: 28, s: 2.3, d: 0.6 }, { x: 14, y: 8, s: 2.3, d: 1.4 },
  { x: 18, y: 40, s: 3, d: 2.1 }, { x: 22, y: 18, s: 2.3, d: 0.3 }, { x: 27, y: 32, s: 2.3, d: 1.8 },
  { x: 31, y: 6, s: 3, d: 1.1 }, { x: 36, y: 22, s: 2.3, d: 2.6 }, { x: 41, y: 14, s: 2.3, d: 0.8 },
  { x: 46, y: 34, s: 3, d: 1.6 }, { x: 52, y: 9, s: 2.3, d: 0.2 }, { x: 58, y: 24, s: 2.3, d: 2.3 },
  { x: 63, y: 15, s: 3, d: 1.0 }, { x: 67, y: 38, s: 2.3, d: 0.5 }, { x: 71, y: 20, s: 2.3, d: 1.9 },
  { x: 76, y: 7, s: 3, d: 2.4 }, { x: 80, y: 30, s: 2.3, d: 0.9 }, { x: 84, y: 16, s: 2.3, d: 1.3 },
  { x: 88, y: 42, s: 3, d: 0.4 }, { x: 92, y: 11, s: 2.3, d: 2.0 }, { x: 96, y: 26, s: 2.3, d: 1.5 },
  { x: 12, y: 48, s: 2.3, d: 2.2 }, { x: 25, y: 46, s: 2.3, d: 0.7 }, { x: 39, y: 44, s: 2.3, d: 1.7 },
  { x: 55, y: 45, s: 2.3, d: 0.1 }, { x: 69, y: 47, s: 2.3, d: 2.5 }, { x: 85, y: 44, s: 2.3, d: 1.2 },
];
